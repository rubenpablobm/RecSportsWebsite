...
Fecha de modificacion: 14/06/2023 */
...
public class AreaInfoDisponibilidadTest {
    ...
    public void muestraInfo(){
        ...
        WebElement tarjetaDisponibilidad = areaInfo.contenedorAccesoLibre.findElement(By.cssSelector(".area-card"));
        JavascriptExecutor jse2 = (JavascriptExecutor)driver;
        jse2.executeScript("arguments[0].scrollIntoView()", tarjetaDisponibilidad);
        wait.until(ExpectedConditions.elementToBeClickable(tarjetaDisponibilidad));
        if (tarjetaDisponibilidad.isDisplayed() && tarjetaDisponibilidad.isEnabled()) {
            jse2.executeScript("arguments[0].click();", tarjetaDisponibilidad);
        }

        tarjetaDisponibilidad.click();
