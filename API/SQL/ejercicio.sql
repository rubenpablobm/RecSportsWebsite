...
--dado
ALTER TABLE [dbo].[Area] DROP CONSTRAINT FK__Area__IdEdificio__5BAD9CC8;
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='Area';
ALTER TABLE [dbo].[Area] ADD CONSTRAINT FK__Area__IdEdificio__5BAD9CC8 FOREIGN KEY (IdEdificio) REFERENCES Edificio(IdEdificio) ON DELETE CASCADE;
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE
FROM INFORMATION_SCHEMA.TABLE_CONSTRAINTS
WHERE TABLE_NAME='Area';